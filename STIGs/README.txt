...
The Security Technical Implementation Guides (STIGs) is a methodology
for standardized secure installation and maintenance of computer
software and hardware created by the Defense Information Systems
Agency (DISA) who provides configuration documents in support of the
United States Department of Defense (DoD).

This community file comes with no warranty of fitness for any purpose. 
